...
class Tests(BasePage):
    ...
    def Log_in_user(self):
        ...
        self.element_is_visible(self.locators.username_fild).send_keys(USER.get('name'))
        self.element_is_visible(self.locators.password_fild).send_keys(USER.get('password'))
        self.element_is_visible(self.locators.log_in_button).click()
    ...
    def Add_API_Key_OKX(self):
        ...
        self.element_is_visible(self.locators.password_api_fild).send_keys(API_OKX.get('api_password'))
        time.sleep(2)
        self.element_is_visible(self.locators.add_account_button_step3).click()
        try:
            self.element_is_visible(self.locators.done_button).click()
